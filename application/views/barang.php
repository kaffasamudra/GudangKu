                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            ...
                            <h6 class="card-subtitle text-muted">
                                <a class="btn btn-primary" href="<?= site_url('barang/tambah') ?>">+ Tambah Barang</a>
                            </h6>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('barang/hapus/' . $b->id) ?>" onclick="return confirm('Yakin ingin menghapus barang ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
