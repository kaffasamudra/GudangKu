                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            ...
                            <h6 class="card-subtitle text-muted">
                                <a class="btn btn-primary" href="<?= site_url('jenis_barang/create') ?>">+ Tambah Jenis Barang</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="myTable" class="table table-striped ov" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('jenis_barang/edit/' . $row->id) ?>">Edit</a> |
                                            <a href="<?= site_url('jenis_barang/delete/' . $row->id) ?>" onclick="return confirm('Yakin mau hapus data ini?')">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
